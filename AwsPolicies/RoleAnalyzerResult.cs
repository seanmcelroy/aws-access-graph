...
{
    public readonly record struct RoleAnalyzerResult
    {
        public readonly bool IamRootAllowed { get; init; }
        public readonly HashSet<string> TrustedEntitiesThatCanAssume { get; init; }
    }
}
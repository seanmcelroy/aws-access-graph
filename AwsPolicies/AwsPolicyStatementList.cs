...
{
    public class AwsPolicyStatementList : List<AwsPolicyStatement>
    {
        internal AwsPolicyStatementList() : base()
        {
        }

        public AwsPolicyStatementList(AwsPolicyStatement statement) : this(new[] { statement })
        {
        }

        public AwsPolicyStatementList(IEnumerable<AwsPolicyStatement> statements) : base(statements)
        {
        }
    }
}